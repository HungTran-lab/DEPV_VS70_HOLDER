...
class MyWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # ngắt mọi kết nối cũ (nếu có), rồi nối kiểu UniqueConnection
        try:
            self.set_model.clicked.disconnect()
        except TypeError:
            pass
        self.set_model.clicked.connect(self.handle_set_model_clicked, Qt.UniqueConnection)
    ...
    def on_set_model_clicked(self):
        """Gửi nội dung show_model xuống cổng COM đã kết nối."""
